...
(function () {
  ...
  var DICT = {
    ...
    acc_optional: { en: 'optional', bn: 'ঐচ্ছিক' },
    acc_country: { en: 'Country', bn: 'দেশ' },
    acc_country_required: { en: 'Please select your country.', bn: 'অনুগ্রহ করে আপনার দেশ নির্বাচন করুন।' },
    acc_consent_required: { en: 'Please accept the Terms & Privacy and Payment Methods to continue.', bn: 'চালিয়ে যেতে অনুগ্রহ করে শর্তাবলী ও গোপনীয়তা এবং পেমেন্ট পদ্ধতি মেনে নিন।' },
    acc_consent_1: { en: 'I agree to the', bn: 'আমি সম্মত' },
    acc_consent_2: { en: 'and', bn: 'এবং' },
    acc_consent_terms: { en: 'Terms & Privacy', bn: 'শর্তাবলী ও গোপনীয়তা' },
    acc_consent_pay: { en: 'Payment Methods', bn: 'পেমেন্ট পদ্ধতিতে' },
