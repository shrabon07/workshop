...
- Correct include for `api/auth/*`, `api/verify/*`, `api/order/create.php` is `../../includes/api.php`.
...
- demo logins: admin `admin@auroracyber.com`/`admin123`; customers `customer@demo.com`/`customer123`, `verified@demo.com`/`verified123`, `full@demo.com`/`full123`, `demo@auroracyber.com`/`demo12345`.